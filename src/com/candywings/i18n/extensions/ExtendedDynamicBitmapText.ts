...
import { ExtendedDynamicBitmapTextConfig, I18nScene, I18nSceneInterface } from "./Interfaces";

export default class ExtendedDynamicBitmapText extends Phaser.GameObjects.BitmapText {
